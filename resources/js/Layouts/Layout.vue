<template>
  <div class="flex">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Ma. Jesusa Alagna</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                ...
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Ma. Jesusa Alagna</h4>
            </div>
        </div>
    </div>
    </div>
    ...
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container px-6 py-3 mx-auto md:flex">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Ma. Jesusa</a>
                </div>
